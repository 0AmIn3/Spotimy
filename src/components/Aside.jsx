...
const Aside = () => {
  return (
    <aside className="w-[18%] h-full  flex flex-col gap-[22px] px-[30px] pt-[70px] bg-[#000000] fixed left-0 bottom-0">
      <section className="flex flex-col gap-[24px] mb-[49px]">
        ...
        >
          ...
          <p className="font-Manrope font-bold text-[18px] text-[#B3B3B3] duration-500 hover:text-[#fff]">
            Home
          </p>
        </NavLink>
        <NavLink
        ...
        >
          ...
          <p className="font-bold font-Manrope text-[18px] text-[#B3B3B3] duration-500 hover:text-[#fff]">
            Search
          </p>
        </NavLink>
        <NavLink
      ...
      <section className="flex flex-col gap-[18px]">
        <p className="font-[500] font-Manrope text-[18px] text-[#B3B3B3] cursor-pointer duration-500 hover:text-[#fff]">
          Chill Mix
        </p>
        <p className="font-[500] font-Manrope text-[18px] text-[#B3B3B3] cursor-pointer duration-500 hover:text-[#fff]">
          Insta Hits
